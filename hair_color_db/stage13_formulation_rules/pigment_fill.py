...
_ONTOLOGY_PATH = Path(__file__).resolve().parent / "A_formulation_ontology.json"
...
def compute_fill_guidance(
    *,
    ...
    When hair is lighter than the target (e.g. level 9 → 5), underlying warm
    pigments must be rebuilt at the skipped levels before applying the final
    base + tone formula.
    """
